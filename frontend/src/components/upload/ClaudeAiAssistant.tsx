    ...
    api.getClaudePrompt()
      ...
      .catch(() => {
        ...
        setPromptText(
          ...
          "- **Department**: [Extracted Name]\n" +
          "- **Semester**: [Extracted Name]\n" +
          "- **Session / Batch**: [Extracted Name]\n" +
          "- **Total Semester Credit**: [X.XX]\n\n" +
          "### Course List:\n" +
          "- [Course Code]: [Course Title] (Credit: [X.XX])\n\n" +
          "| S/N | Student ID | Student Name | [CODE_1] GP | [CODE_1] LG | [CODE_2] GP | [CODE_2] LG | [CONTINUE_FOR_ALL_COURSES...] | Total GP | GPA | Cumulative Credits | CGPA | Result Status |\n" +
          "|---|---|---|---|---|---|---|---|---|---|---|---|---|\n" +
          "| 1 | [ID] | [Name] | 4.00 | A+ | 3.75 | A | [ALL_GRADES] | 78.50 | 3.85 | 21.50 | 3.85 | P |\n"
        );
      });
  }, []);
