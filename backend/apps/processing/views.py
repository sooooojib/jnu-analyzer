...
class ClaudePromptView(APIView):
    ...
    def get(self, request):
        prompt_text = (
            ...
            "- **Semester**: [Extracted Semester / Exam Name, e.g. B.Sc. 1st Year 1st Semester Examination 2023]\n"
            ...
            "|---|---|---|---|---|---|---|---|---|---|---|---|---|\n"
            "| 1 | [Student ID 1] | [Student Name 1] | 4.00 | A+ | 3.75 | A | ... | 78.50 | 3.85 | 21.50 | 3.85 | P |\n"
            "| 2 | [Student ID 2] | [Student Name 2] | 3.50 | A- | 4.00 | A+ | ... | 72.00 | 3.55 | 21.50 | 3.55 | P |\n\n"
